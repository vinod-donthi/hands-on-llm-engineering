...
**Learning path:** `week-01/` (read) · **Work path:** `week-01-work/` in repo or `~/ai-learning/week-01-work/` (code)
...
| [Minimum viable Week 1](project/minimum-viable-week1.md) (if using Path B) | [ ] |
